...
public class PageWidget extends View {
	...
	private static final String TAG = "eview_reader";
	private int mWidth;
	private int mHeight;
	...
	public PageWidget(Context context,int m,int n) {
		super(context);
		mPath0 = new Path();
		mPath1 = new Path();
		createDrawable();
	...
	public boolean doTouchEvent(MotionEvent event,PopupWindow popup) {
